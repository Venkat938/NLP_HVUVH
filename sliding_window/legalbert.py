...
model_args.output_dir = "bertlegaloutput/"
...
model = ClassificationModel('bert', 'casehold/legalbert', num_labels=2,weight=[1,1.5],use_cuda = cuda_available, args = model_args)
